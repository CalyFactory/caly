...
class Member(MethodView):
	...
	def post(self,action):
		if action == 'loginCheck':
			...
			if app_version == current_version or app_version == next_version or app_version == next_version + '_' + conf['versionOpt'] or app_version == current_version + '_' + conf['versionOpt'] or app_version == 'null':
