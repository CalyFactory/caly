...
SYNC_END_TIME_STATE_FORWARD_START = 0
SYNC_END_TIME_STATE_FORWARD = 1
SYNC_END_TIME_STATE_BACKWARD = 2
#주기적동기화
SYNC_END_TIME_STATE_PERIOD = 3
...
EVENT_RECO_STATUS_ING = 1
EVENT_RECO_STATUS_FAILE = 2
EVENT_RECO_STATUS_SUCCESS = 3
...
#MongDBCollection Names
MONGO_COLLECTION_EVENT_LOG = 'MONGO_COLLECTION_EVENT_LOG'
MONGO_COLLECTION_RECO_LOG = 'MONGO_COLLECTION_RECO_LOG'
MONGO_COLLECTION_ACCOUNT_LIST_LOG = 'MONGO_COLLECTION_ACCOUNT_LIST_LOG'
MONGO_COLLECTION_SCREEN_LOG = 'MONGO_COLLECTION_SCREEN_LOG'

#google watch Call
GOOGLE_WATCH_CALL = 'GOOGLE_WATCH_CALL'
GOOGLE_WATCH_ATTACH = 'GOOGLE_WATCH_ATTACH'
GOOGLE_CRON_WATCH_ATTACH = 'GOOGLE_CRON_WATCH_ATTACH'
GOOGLE_WATCH_DETACH = 'GOOGLE_WATCH_DETACH'

# GOOGLE_CRON_WATCH_ATTACH = 'GOOGLE_CRON_WATCH_ATTACH'
# GOOGLE_CRON_WATCH_DETACH = 'GOOGLE_CRON_WATCH_DETACH'
...
LOGIN_STATE_CHANGEPW = 'LOGIN_STATE_CHANGEPW'
...
LIFE_STATE_SIGNIN_RELOGIN_OTHERACCOUNT = 'LIFE_STATE_SIGNIN_RELOGIN_OTHERACCOUNT'
...
#유저가 계정을 삭제했을겨우
LIFE_STATE_REMOVE_ACCOUNT = 'LIFE_STATE_REMOVE_ACCOUNT'
#에러가 나왔을경우
...
MSG_LOGIN_NEED_CHANGE_PW = 'neeed change pw'

#sync
MSG_SYNC_ALREADY = 'sync already end'
MSG_SYNC_NEED = 'sync need'
MSG_SYNC_ING = 'syncing.. wait'
